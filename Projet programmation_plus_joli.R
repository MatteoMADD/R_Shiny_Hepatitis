...
ui <- fluidPage(
             ...
             sidebarLayout(
               sidebarPanel(
                   ...
                   fluidRow(
                     ...
                     actionButton('load_data', 'Charger les données', class = 'btn-primary btn-block'),
                     actionButton('summary_button', "Sommaire", class = 'btn-primary btn-block'),
                     actionButton('structure_button', "Structure", class = 'btn-primary btn-block')
                   )
  ...
  tabsetPanel(
    ...
    tabPanel('Tableau de données',
             ...
             style = "overflow-x: auto; overflow-y: auto; max-height: 500px; padding: 20px;"
    ),
               ...
               mainPanel(
                 tabsetPanel(
                   ...
                   tabPanel('Tableau avec imputation',
                            DTOutput('data_imputed'),style = "overflow-x: auto; overflow-y: auto; max-height: 500px; padding: 20px;"),
    ...
    tabPanel('Prétraitement de données',
             sidebarLayout(
               sidebarPanel(
                 actionButton("dummify_button", "Dummification", class = 'btn-primary btn-block'),
                 ...
                 actionButton("generate_final_table_button", "Générer le tableau final", class = 'btn-primary btn-block')
               ),
               mainPanel(

                 tabsetPanel(
                   id = "tabs2",
                   tabPanel('Tableau dummifié', DTOutput('dummified_table'),
             style = "overflow-x: auto; overflow-y: auto; max-height: 500px; padding: 20px;"),
                   tabPanel('Tableau normalisé', DTOutput('normalized_table'),
             style = "overflow-x: auto; overflow-y: auto; max-height: 500px; padding: 20px;"),
                   tabPanel('Tableau final', DTOutput('final_table'),
             style = "overflow-x: auto; overflow-y: auto; max-height: 500px; padding: 20px;")
                 )
               )
             )
